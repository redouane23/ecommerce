...
window.Element&&!Element.prototype.closest&&(Element.prototype.closest=function(e){var t,n=(this.document||this.ownerDocument).querySelectorAll(e),o=this;do{for(t=n.length;0<=--t&&n.item(t)!==o;);}while(t<0&&(o=o.parentElement));return o}),function(){function e(e,t){t=t||{bubbles:!1,cancelable:!1,detail:void 0};var n=document.createEvent("CustomEvent");return n.initCustomEvent(e,t.bubbles,t.cancelable,t.detail),n}"function"!=typeof window.CustomEvent&&(e.prototype=window.Event.prototype,window.CustomEvent=e)}(),function(){for(var i=0,e=["ms","moz","webkit","o"],t=0;t<e.length&&!window.requestAnimationFrame;++t)window.requestAnimationFrame=window[e[t]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[e[t]+"CancelAnimationFrame"]||window[e[t]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(e,t){var n=(new Date).getTime(),o=Math.max(0,16-(n-i)),a=window.setTimeout(function(){e(n+o)},o);return i=n+o,a}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(e){clearTimeout(e)})}(),function(e,t){"function"==typeof define&&define.amd?define([],function(){return t(e)}):"object"==typeof exports?module.exports=t(e):e.SmoothScroll=t(e)}("undefined"!=typeof global?global:"undefined"!=typeof window?window:this,function(C){"use strict";function M(){var n={};return Array.prototype.forEach.call(arguments,function(e){for(var t in e){if(!e.hasOwnProperty(t))return;n[t]=e[t]}}),n}function i(e){"#"===e.charAt(0)&&(e=e.substr(1));for(var t,n=String(e),o=n.length,a=-1,i="",r=n.charCodeAt(0);++a<o;){if(0===(t=n.charCodeAt(a)))throw new InvalidCharacterError("Invalid character: the input contains U+0000.");i+=1<=t&&t<=31||127==t||0===a&&48<=t&&t<=57||1===a&&48<=t&&t<=57&&45===r?"\\"+t.toString(16)+" ":128<=t||45===t||95===t||48<=t&&t<=57||65<=t&&t<=90||97<=t&&t<=122?n.charAt(a):"\\"+n.charAt(a)}return"#"+i}function q(){return Math.max(document.body.scrollHeight,document.documentElement.scrollHeight,document.body.offsetHeight,document.documentElement.offsetHeight,document.body.clientHeight,document.documentElement.clientHeight)}function I(e,t,n,o){if(t.emitEvents&&"function"==typeof C.CustomEvent){var a=new CustomEvent(e,{bubbles:!0,detail:{anchor:n,toggle:o}});document.dispatchEvent(a)}}var F={ignore:"[data-scroll-ignore]",header:null,topOnEmptyHash:!0,speed:500,speedAsDuration:!1,durationMax:null,durationMin:null,clip:!0,offset:0,easing:"easeInOutCubic",customEasing:null,updateURL:!0,popstate:!0,emitEvents:!0};return function(o,e){var E,a,b,A,O={cancelScroll:function(e){cancelAnimationFrame(A),A=null,e||I("scrollCancel",E)}};O.animateScroll=function(r,c,e){O.cancelScroll();var t,s=M(E||F,e||{}),u="[object Number]"===Object.prototype.toString.call(r),n=u||!r.tagName?null:r;if(u||n){var l=C.pageYOffset;s.header&&!b&&(b=document.querySelector(s.header));var o,a,m,i,d,f,h=(t=b)?parseInt(C.getComputedStyle(t).height,10)+t.offsetTop:0,p=u?r:function(e,t,n,o){var a=0;if(e.offsetParent)for(;a+=e.offsetTop,e=e.offsetParent;);return a=Math.max(a-t-n,0),o&&(a=Math.min(a,q()-C.innerHeight)),a}(n,h,parseInt("function"==typeof s.offset?s.offset(r,c):s.offset,10),s.clip),g=p-l,y=q(),w=0,v=(a=(o=s).speedAsDuration?o.speed:Math.abs(g/1e3*o.speed),o.durationMax&&a>o.durationMax?o.durationMax:o.durationMin&&a<o.durationMin?o.durationMin:parseInt(a,10)),S=function(e){var t,n;w+=e-(m=m||e),d=l+g*(t=i=1<(i=0===v?0:w/v)?1:i,"easeInQuad"===s.easing&&(n=t*t),"easeOutQuad"===s.easing&&(n=t*(2-t)),"easeInOutQuad"===s.easing&&(n=t<.5?2*t*t:(4-2*t)*t-1),"easeInCubic"===s.easing&&(n=t*t*t),"easeOutCubic"===s.easing&&(n=--t*t*t+1),"easeInOutCubic"===s.easing&&(n=t<.5?4*t*t*t:(t-1)*(2*t-2)*(2*t-2)+1),"easeInQuart"===s.easing&&(n=t*t*t*t),"easeOutQuart"===s.easing&&(n=1- --t*t*t*t),"easeInOutQuart"===s.easing&&(n=t<.5?8*t*t*t*t:1-8*--t*t*t*t),"easeInQuint"===s.easing&&(n=t*t*t*t*t),"easeOutQuint"===s.easing&&(n=1+--t*t*t*t*t),"easeInOutQuint"===s.easing&&(n=t<.5?16*t*t*t*t*t:1+16*--t*t*t*t*t),s.customEasing&&(n=s.customEasing(t)),n||t),C.scrollTo(0,Math.floor(d)),function(e,t){var n,o,a,i=C.pageYOffset;if(e==t||i==t||(l<t&&C.innerHeight+i)>=y)return O.cancelScroll(!0),o=t,a=u,0===(n=r)&&document.body.focus(),a||(n.focus(),document.activeElement!==n&&(n.setAttribute("tabindex","-1"),n.focus(),n.style.outline="none"),C.scrollTo(0,o)),I("scrollStop",s,r,c),!(A=m=null)}(d,p)||(A=C.requestAnimationFrame(S),m=e)};0===C.pageYOffset&&C.scrollTo(0,0),f=r,u||history.pushState&&s.updateURL&&history.pushState({smoothScroll:JSON.stringify(s),anchor:f.id},document.title,f===document.documentElement?"#top":"#"+f.id),"matchMedia"in C&&C.matchMedia("(prefers-reduced-motion)").matches?C.scrollTo(0,Math.floor(p)):(I("scrollStart",s,r,c),O.cancelScroll(!0),C.requestAnimationFrame(S))}};function t(e){if(!e.defaultPrevented&&!(0!==e.button||e.metaKey||e.ctrlKey||e.shiftKey)&&"closest"in e.target&&(a=e.target.closest(o))&&"a"===a.tagName.toLowerCase()&&!e.target.closest(E.ignore)&&a.hostname===C.location.hostname&&a.pathname===C.location.pathname&&/#/.test(a.href)){var t,n=i(a.hash);if("#"===n){if(!E.topOnEmptyHash)return;t=document.documentElement}else t=document.querySelector(n);(t=t||"#top"!==n?t:document.documentElement)&&(e.preventDefault(),function(){if(history.replaceState&&E.updateURL&&!history.state){var e=C.location.hash;e=e||"",history.replaceState({smoothScroll:JSON.stringify(E),anchor:e||C.pageYOffset},document.title,e||C.location.href)}}(),O.animateScroll(t,a))}}function n(e){if(null!==history.state&&history.state.smoothScroll&&history.state.smoothScroll===JSON.stringify(E)){var t=history.state.anchor;"string"==typeof t&&t&&!(t=document.querySelector(i(history.state.anchor)))||O.animateScroll(t,null,{updateURL:!1})}}return O.destroy=function(){E&&(document.removeEventListener("click",t,!1),C.removeEventListener("popstate",n,!1),O.cancelScroll(),A=b=a=E=null)},function(){if(!("querySelector"in document&&"addEventListener"in C&&"requestAnimationFrame"in C&&"closest"in C.Element.prototype))throw"Smooth Scroll: This browser does not support the required JavaScript methods and browser APIs.";O.destroy(),E=M(F,e||{}),b=E.header?document.querySelector(E.header):null,document.addEventListener("click",t,!1),E.updateURL&&E.popstate&&C.addEventListener("popstate",n,!1)}(),O}});
